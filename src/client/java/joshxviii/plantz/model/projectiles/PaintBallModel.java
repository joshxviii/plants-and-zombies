...
public class PaintBallModel extends EntityModel<@NotNull ProjectileRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(pazResource("paint_ball"), "main");
    private final ModelPart body;

    public PaintBallModel(ModelPart root) {
        super(root);
