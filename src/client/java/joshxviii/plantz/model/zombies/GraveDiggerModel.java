...
public class GraveDiggerModel extends PazZombieModel {
	...
	public GraveDiggerModel(final ModelPart root) {
		super(null, root);
		this.walkAnimation = GraveDiggerAnimation.walk.bake(root.getChild("root"));
		this.actionAnimation = GraveDiggerAnimation.build.bake(root.getChild("root"));
	}
