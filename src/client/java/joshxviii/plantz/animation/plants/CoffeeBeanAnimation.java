 ...
 * @author Nate
 */
public class CoffeeBeanAnimation {
	public static final AnimationDefinition idle = AnimationDefinition.Builder.withLength(2.0F).looping()
			.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.2427F), AnimationChannel.Interpolations.LINEAR)
			))
	...
	public static final AnimationDefinition sleep = AnimationDefinition.Builder.withLength(4.0F).looping()
			.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(1.64F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.2427F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(2.879F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.2427F), AnimationChannel.Interpolations.LINEAR),
